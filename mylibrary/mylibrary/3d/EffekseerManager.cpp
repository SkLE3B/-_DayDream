...
Effekseer::Handle EffekseerManager::PlayEffect(const char16_t* arg_effectName, const Vector3& arg_position)
{
...
Effekseer::EffectRef EffekseerManager::GetEffect(const char16_t* arg_effectName)
{
