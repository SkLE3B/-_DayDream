...
public:
	...
	/// <returns></returns>
	static Effekseer::Handle PlayEffect(const char16_t* arg_effectName, const Vector3& arg_position);
	...
	/// <param name="arg_effectName"></param>
	/// <returns></returns>
	static Effekseer::EffectRef GetEffect(const char16_t* arg_effectName);
