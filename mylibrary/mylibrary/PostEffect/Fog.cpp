...
void Fog::Initialize(Camera* camera)
{
	...
	CD3DX12_HEAP_PROPERTIES heapProCpu = CD3DX12_HEAP_PROPERTIES(D3D12_CPU_PAGE_PROPERTY_WRITE_BACK,
		D3D12_MEMORY_POOL_L0);
	CD3DX12_CLEAR_VALUE clearValue = CD3DX12_CLEAR_VALUE(DXGI_FORMAT_R8G8B8A8_UNORM, clearColor);
	...
	CD3DX12_HEAP_PROPERTIES heapCpu = CD3DX12_HEAP_PROPERTIES(D3D12_CPU_PAGE_PROPERTY_WRITE_BACK, D3D12_MEMORY_POOL_L0);
	...
	CD3DX12_HEAP_PROPERTIES heapDep = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT);
